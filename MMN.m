...
curText = ['<color=ffffff>Now we are ready to start the second part.\n'...
    ...
    'There will be 26 blocks. At the end of each block, you will watch a short video to take a break.\n'...
...
blockNumber = 36; %%change the block number, which should always be even
trialNumber = 36;
